-- Admin-created customers using existing tables only:
-- auth.users, profiles, customers, bank_accounts, nominees.
-- Adds optional columns on bank_accounts (no new tables).
-- Does not create investments (use Add Investment separately).
